...
export default function AnalysisPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#09090f]">
      ...
      <main className="relative mx-auto max-w-7xl px-4 pt-10 pb-24 sm:px-6 lg:px-8">
        ...
        <div className="relative mb-8 overflow-hidden rounded-2xl border border-indigo-200/50 dark:border-indigo-500/20">
          ...
          <div className="relative z-10 flex flex-col gap-4 p-4 sm:p-6 md:p-8 sm:flex-row sm:items-center sm:justify-between">
            {/* Left: icon + title */}
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <h1 className="text-lg sm:text-xl md:text-2xl font-extrabold tracking-tight text-slate-900 dark:text-white leading-none break-words">
                  Content Analysis
                </h1>
            ...
            <div className="flex flex-wrap items-center gap-2 flex-shrink-0">
              ...
              <Link
                ...
                className="inline-flex w-full sm:w-auto items-center justify-center gap-1.5 rounded-xl border border-slate-200/80 dark:border-white/[0.08] bg-white/80 dark:bg-white/[0.04] backdrop-blur-sm px-3 py-2 text-xs font-medium text-slate-600 dark:text-white/50 hover:bg-white dark:hover:bg-white/[0.07] hover:border-sky-300 dark:hover:border-sky-500/30 transition-all"
              >
